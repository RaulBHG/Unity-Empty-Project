...
namespace TFF.Core.DesignPatterns.Editor.StateMachine
{
	internal static class ContentStyle
	{
		...
		internal static void Initialize()
		{
			...
			DarkGray = EditorGUIUtility.isProSkin ?
				new Color(0.283f, 0.283f, 0.283f) : new Color(0.7f, 0.7f, 0.7f);
			LightGray = EditorGUIUtility.isProSkin ?
				new Color(0.33f, 0.33f, 0.33f) : new Color(0.8f, 0.8f, 0.8f);
			...
			guiStyleStateNormal.textColor = EditorGUIUtility.isProSkin ?
				new Color(.85f, .85f, .85f) : new Color(0.337f, 0.337f, 0.337f);
